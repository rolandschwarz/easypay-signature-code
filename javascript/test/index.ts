...
import SignatureNS = require("../easpay.lib/Signature");
...
describe('Easypay', () => {
    describe('Signature', () => {
        it('should produce constant hash for predefined hashString', () => {
        ...
        it('should produce constant hash for predefined json', () => {
    ...
    describe('EasypayRequest', () => {
		it('should produce constant base64 string for predefined data', ()=> {
        ...
        it('should produce constant url for predefined paymentRequest', () => {
